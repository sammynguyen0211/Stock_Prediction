...
MODEL_INFO = {
        ...
        "keys": ['AAPL', 'NVDA', 'TSLA','AMD','META','DEXJPUS', 'DEXUSUK','SP500', 'NASDAQCOM', 'VIXCLS']
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ['AAPL', 'NVDA', 'TSLA','AMD','META','DEXJPUS', 'DEXUSUK','SP500', 'NASDAQCOM', 'VIXCLS']]]
}
